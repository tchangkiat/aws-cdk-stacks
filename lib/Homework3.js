...
class Homework3 extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const provider = new iam.OpenIdConnectProvider(this, 'iam-oidc-provider', {
  ...
  enableAutoscaling(cluster, ng, version = "v1.22.1") {
    ...
    Tag.add(ng, `k8s.io/cluster-autoscaler/${clusterName}`, "owned", { applyToLaunchedInstances: true });
    Tag.add(ng, "k8s.io/cluster-autoscaler/enabled", "true", { applyToLaunchedInstances: true });
