const { Stack, CfnOutput, CfnJson, Duration, Tags } = require("aws-cdk-lib");
const ec2 = require("aws-cdk-lib/aws-ec2");
const iam = require("aws-cdk-lib/aws-iam");
const eks = require("aws-cdk-lib/aws-eks");
const { Karpenter, AMIFamily, CapacityType } = require("cdk-karpenter");
const { ManagedNodeGroup } = require("../constructs/EKS");
...
class EKS extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    this.configureNodeGroupForAutoscaling(clusterName, addons_mng, "addons-mng-");
