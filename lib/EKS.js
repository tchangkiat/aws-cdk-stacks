...
class EKS extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const eksNodeRole = new iam.Role(this, "node-role", {
      ...
      roleName: "eks-" + eksClusterName + "-node",
    });
    ...
    const eksNodeLaunchTemplate = new ec2.CfnLaunchTemplate(
      this,
      "on-demand-node-launch-template",
      {
        launchTemplateName:
          "eks-" + eksClusterName + "-on-demand-node-launch-template",
        launchTemplateData: {
          blockDeviceMappings: [
            {
              deviceName: "/dev/xvda",
          ...
          tagSpecifications: [
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: "eks-" + eksClusterName + "-on-demand-node",
                },
              ],
            },
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: "eks-" + eksClusterName + "-on-demand-node-volume",
                },
              ],
            },
          ],
    ...
    const mng = cluster.addNodegroupCapacity("on-demand-mng", {
      amiType: eks.NodegroupAmiType.BOTTLEROCKET_X86_64,
      desiredSize: 1,
      minSize: 0,
      maxSize: 2,
      nodegroupName: "on-demand",
    ...
    const eksSpotNodeLaunchTemplate = new ec2.CfnLaunchTemplate(
      ...
      {
        launchTemplateName:
          "eks-" + eksClusterName + "-spot-node-launch-template",
        launchTemplateData: {
          blockDeviceMappings: [
            {
              deviceName: "/dev/xvda",
          ...
          tagSpecifications: [
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: "eks-" + eksClusterName + "-spot-node",
                },
              ],
            },
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: "eks-" + eksClusterName + "-spot-node-volume",
                },
              ],
            },
          ],
