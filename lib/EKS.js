...
class EKS extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const eksClusterKubernetesVersion = eks.KubernetesVersion.V1_21;
    const eksClusterAutoscalerVersion = "v1.22.1";
    const eksClusterAlbControllerVersion = eks.AlbControllerVersion.V2_4_1;
    ...
    const cluster = new eks.Cluster(this, "eks-cluster", {
      albController: {
        version: eksClusterAlbControllerVersion,
      },
      clusterLogging: [
    ...
    if (enableClusterAutoscaler) {
      this.enableAutoscaling(cluster, ng, eksClusterAutoscalerVersion);
    }
