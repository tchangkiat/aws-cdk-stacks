...
class EKS extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const eksAddOnsNodeLaunchTemplate = new ec2.CfnLaunchTemplate(
      this,
      "addons-launch-template",
      {
        launchTemplateName: resourcePrefix + eksClusterName + "/addons",
        launchTemplateData: {
          blockDeviceMappings: [
            {
              deviceName: "/dev/xvda",
          ...
          tagSpecifications: [
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: resourcePrefix + eksClusterName + "/addons",
                },
              ],
            },
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: resourcePrefix + eksClusterName + "/addons/volume",
                },
              ],
            },
          ],
    ...
    /*const eksSpotNodeLaunchTemplate = new ec2.CfnLaunchTemplate(
      ...
      {
        launchTemplateName:
          resourcePrefix + eksClusterName + "/spot",
        launchTemplateData: {
          blockDeviceMappings: [
            {
              deviceName: "/dev/xvda",
          ...
          tagSpecifications: [
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: resourcePrefix + eksClusterName + "/spot",
                },
              ],
            },
            {
              ...
              tags: [
                {
                  key: "Name",
                  value: resourcePrefix + eksClusterName + "/spot/volume",
                },
              ],
            },
          ],
  ...
  configureNodeGroupForAutoscaling(clusterName, ng, prefix) {
    ...
    karpenter.addProvisioner("spot", {
      ...
      provider: {
        ...
        tags: {
          Name: resourcePrefix + eksClusterName + "/karpenter/spot",
        },
      },
    });
  }
