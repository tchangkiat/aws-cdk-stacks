...
class EKS extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const eksClusterKubernetesVersion = eks.KubernetesVersion.of("1.26");

    const eksClusterName = id + "-demo";

    const autoscaler = props.autoscaler || "";
    ...
    bastionHost.addUserData(
      [
        ...
        "sudo ./aws/install",
        // kubectl
        "curl -o kubectl https://s3.us-west-2.amazonaws.com/amazon-eks/1.26.2/2023-03-17/bin/linux/arm64/kubectl",
        "chmod +x ./kubectl",
