...
sudo echo 'export VLLM_TARGET_DEVICE=cpu' | tee -a $HOME/.bashrc $HOME/.zshrc
sudo echo 'export VLLM_CPU_KVCACHE_SPACE=40' | tee -a $HOME/.bashrc $HOME/.zshrc
sudo echo 'export VLLM_CPU_OMP_THREADS_BIND=0-30' | tee -a $HOME/.bashrc $HOME/.zshrc
sudo echo 'export VLLM_CPU_DISABLE_AVX512="true"' | tee -a $HOME/.bashrc $HOME/.zshrc
